document.addEventListener("DOMContentLoaded", function () {
    ...
    // Ambil container dan render semua item dari `lostItems` (yang ada di lost_data.js)
    // Kita cek dulu apakah lostItems dan container ada, untuk mencegah error
    const itemsToDisplay = loadItems('lostItems', lostItems);
